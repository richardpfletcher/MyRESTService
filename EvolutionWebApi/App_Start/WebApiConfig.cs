...
namespace EvolutionWebApi
{
    ...
    public static class WebApiConfig
    {
        public static void Register(HttpConfiguration config)
        {
            ...
            //var cors = new EnableCorsAttribute("http://localhost:34667/", "*", "*");
            ...
            //We're going to use our own formatters so we have better control over the output
            //We start by clearing all the default built-in .Net formatters...
            config.Formatters.Clear();

            //Now we add our own formatter methods
            config.Formatters.Add(new BrowserJsonFormatter());
            //config.Formatters.Add(new CustomNamespaceXmlFormatter());

            //Since we added our own formatters, we now have to use our own custom Content Negotiation scheme
            //in order to detect the incoming data type in the Content-Type and Accept headers.
