...
{
    internal class LoadKeysTeachingsOfTheDragons
    {
        private static LoadKeysTeachingsOfTheDragons _instance;

        public static List<BookModel> list = new List<BookModel>();

        // Constructor is 'protected'
        protected LoadKeysTeachingsOfTheDragons()
        {
            int counter = 0;
            //talks
            ...
            list.Add(new BookModel(counter++, "Eight limbs Commentary"));
            list.Add(new BookModel(counter++, "Yamas social restraints"));
            //list.Add(new BookModel(counter++, "Jainism Mahavira quotes"));
        ...
        public static LoadKeysTeachingsOfTheDragons Instance()
        {
            // Uses lazy initialization.
            // Note: this is not thread safe.
            if (_instance == null)
            {
                _instance = new LoadKeysTeachingsOfTheDragons();
            }
