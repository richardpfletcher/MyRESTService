...
{
    internal class LoadKeysCatalyst
    {
        private static LoadKeysCatalyst _instance;

        public static List<BookModel> list = new List<BookModel>();

        // Constructor is 'protected'
        protected LoadKeysCatalyst()
        {
            int counter = 0;
            //talks
        ...
        public static LoadKeysCatalyst Instance()
        {
            // Uses lazy initialization.
            // Note: this is not thread safe.
            if (_instance == null)
            {
                _instance = new LoadKeysCatalyst();
            }
