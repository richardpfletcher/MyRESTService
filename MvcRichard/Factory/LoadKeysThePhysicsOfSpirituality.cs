...
{
    internal class LoadKeysThePhysicsOfSpirituality
    {
        private static LoadKeysThePhysicsOfSpirituality _instance;

        public static List<BookModel> list = new List<BookModel>();

        // Constructor is 'protected'
        protected LoadKeysThePhysicsOfSpirituality()
        {
            int counter = 0;
            //talks
        ...
        public static LoadKeysThePhysicsOfSpirituality Instance()
        {
            // Uses lazy initialization.
            // Note: this is not thread safe.
            if (_instance == null)
            {
                _instance = new LoadKeysThePhysicsOfSpirituality();
            }
