...
{
    internal class LoadKeysFamily
    {
        private static LoadKeysFamily _instance;

        public static List<BookModel> list = new List<BookModel>();

        // Constructor is 'protected'
        protected LoadKeysFamily()
        {
            int counter = 0;
            //talks
        ...
        public static LoadKeysFamily Instance()
        {
            // Uses lazy initialization.
            // Note: this is not thread safe.
            if (_instance == null)
            {
                _instance = new LoadKeysFamily();
            }
