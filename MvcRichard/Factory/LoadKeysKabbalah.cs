...
{
    internal class LoadKeysKabbalah
    {
        private static LoadKeysKabbalah _instance;

        public static List<BookModel> list = new List<BookModel>();

        // Constructor is 'protected'
        protected LoadKeysKabbalah()
        {
            int counter = 0;
            //talks
            ...
            //list.Add(new BookModel(counter++, "Jody"));
            //list.Add(new BookModel(counter++, "Steve Hudson RIP"));
            //list.Add(new BookModel(counter++, "Sugar And Spice"));


            //list.Add(new BookModel(counter++, "Chris Dahl"));
            //list.Add(new BookModel(counter++, "More Childhood Friends 1"));
            //list.Add(new BookModel(counter++, "More Childhood Friends 2"));
            //list.Add(new BookModel(counter++, "More Childhood Friends 3"));
            //list.Add(new BookModel(counter++, "Liz Priest"));



            //list.Add(new BookModel(counter++, "Mentors"));
            //list.Add(new BookModel(counter++, "My High School Poetry Teacher"));
            //list.Add(new BookModel(counter++, "CADIE Program"));
            //list.Add(new BookModel(counter++, "AFS"));
            ...
            //list.Add(new BookModel(counter++, "Linda Graham"));
            ...
            //list.Add(new BookModel(counter++, "Barbara"));
            //list.Add(new BookModel(counter++, "Aleai"));
            ...
            //list.Add(new BookModel(counter++, "Chanda"));
            //list.Add(new BookModel(counter++, "Mom"));
            ...
            //list.Add(new BookModel(counter++, "Friends"));
            //list.Add(new BookModel(counter++, "Your True Friends"));
            //list.Add(new BookModel(counter++, "Making Friends With Dragons"));
            //list.Add(new BookModel(counter++, "My Dear Friend"));
            ...
            list.Add(new BookModel(counter++, "Family"));
            ...
            list.Add(new BookModel(counter++, "The Gerstner’s"));
        ...
        public static LoadKeysKabbalah Instance()
        {
            // Uses lazy initialization.
            // Note: this is not thread safe.
            if (_instance == null)
            {
                _instance = new LoadKeysKabbalah();
            }
