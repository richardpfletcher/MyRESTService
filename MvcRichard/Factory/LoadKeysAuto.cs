...
{
    internal class LoadKeysAuto
    {
        private static LoadKeysAuto _instance;

        public static List<BookModel> list = new List<BookModel>();

        // Constructor is 'protected'
        protected LoadKeysAuto()
        {
            int counter = 0;
            //talks

            list.Add(new BookModel(counter++, "intro"));
            list.Add(new BookModel(counter++, "Intro side a"));
            list.Add(new BookModel(counter++, "Intro side b"));
            ...
            list.Add(new BookModel(counter++, "As a man of forty"));
            list.Add(new BookModel(counter++, "Focus"));
            list.Add(new BookModel(counter++, "Sailing"));
            list.Add(new BookModel(counter++, "War"));
            list.Add(new BookModel(counter++, "Is life like a rubber band"));
            list.Add(new BookModel(counter++, "Life is a garland"));
            list.Add(new BookModel(counter++, "Meditation"));
            list.Add(new BookModel(counter++, "Stairway of life"));
            list.Add(new BookModel(counter++, "Empty trinkets of life"));
            list.Add(new BookModel(counter++, "He who says doesn't know"));
        ...
        public static LoadKeysAuto Instance()
        {
            // Uses lazy initialization.
            // Note: this is not thread safe.
            if (_instance == null)
            {
                _instance = new LoadKeysAuto();
            }
