...
{
    internal class LoadKeysFromMeToWe
    {
        private static LoadKeysFromMeToWe _instance;

        public static List<BookModel> list = new List<BookModel>();

        // Constructor is 'protected'
        protected LoadKeysFromMeToWe()
        {
            int counter = 0;
            //talks
        ...
        public static LoadKeysFromMeToWe Instance()
        {
            // Uses lazy initialization.
            // Note: this is not thread safe.
            if (_instance == null)
            {
                _instance = new LoadKeysFromMeToWe();
            }
