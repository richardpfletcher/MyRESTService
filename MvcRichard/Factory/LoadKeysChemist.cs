...
namespace MvcRichard.Factory
{
    internal class LoadKeysChemist
    {
        ...
        protected LoadKeysChemist()
        {
            ...
            list.Add(new BookModel(counter++, "Shaucha(शौच) purity-New Personality"));
            ...
            list.Add(new BookModel(counter++, "Memorize and act consciously over and over again"));
            ...
            list.Add(new BookModel(counter++, "Being a victim vs being a creator"));
            list.Add(new BookModel(counter++, "Non-Placebo effect"));
            list.Add(new BookModel(counter++, "Habits take at least three weeks"));
