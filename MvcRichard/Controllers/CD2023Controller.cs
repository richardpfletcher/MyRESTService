...
{
    public class CD2023Controller : Controller
    {
        ...
        public ActionResult CD112()
        {
            String Path = Server.MapPath("/Audio/CD/CD112");
            String[] FileNames = Directory.GetFiles(Path);
            ...
            foreach (string path in FileNames) //iterate the file list
            {
                ...
                if (shortname == "Intro")
                {
                    list.Add(new DocumentModel(fullname, shortname, "\\Audio\\CD\\CD112\\" + fullname, "http://www.evolutionrevolutionoflove.com/Audio/CD/CD112/" + fullname));
                }
            }
