...
app.controller('CtrlSearch', ['$scope', '$http', '$window', '$interval', 'uiGridConstants', function ($scope, $http, $window, $interval, uiGridConstants) {
    ...
    //var apiPath = "/api/";
    //change this later
    //var apiPath = "http://www.evolutionrevolutionoflove.com/evolution/api/";
    ...
    $scope.gridOptions.onRegisterApi = function (gridApi) {
        ...
        gridApi.selection.on.rowSelectionChanged($scope, function (row) {
            ...
            myEl.html($scope.ShortName + '</div > <div><audio controls><source src="' + $scope.PathName + '" type="audio/mp3">Your browser does not support the audio element.</audio></div></div>');
