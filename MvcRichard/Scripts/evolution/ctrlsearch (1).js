...
app.controller('CtrlSearch', ['$scope', '$http', '$window', '$interval', 'uiGridConstants', function ($scope, $http, $window, $interval, uiGridConstants) {
    ...
    //var apiPath = "http://localhost:18760/api/";
    //var apiPath = "/api/";
    //change this later
    //var apiPath = "http://www.api.evolutionrevolutionoflove.com/evolution/api/";
    var apiPath = "http://api.evolutionrevolutionoflove.com/api/";
    //var apiPath = "localhost:18760/api/";
    $scope.productList = [];
    $scope.categoryList = [];
    ...
    $scope.gridOptions.onRegisterApi = function (gridApi) {
        ...
        gridApi.selection.on.rowSelectionChanged($scope, function (row) {
            ...
            myEl.html($scope.ShortName + '</div > <div><audio controls><source src="' + $scope.PathName + '" type="audio/mpeg">Your browser does not support the audio element.</audio></div></div>');
